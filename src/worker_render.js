 ...
 */
import { ErrorHandler, Injectable, Injector, NgZone, OpaqueToken, PLATFORM_INITIALIZER, RootRenderer, Testability, createPlatformFactory, isDevMode, platformCore } from '@angular/core/index';
 ...
 * @experimental WebWorker support is currently experimental.
 */
export const /** @type {?} */ WORKER_SCRIPT = new OpaqueToken('WebWorkerScript');
/**
 ...
 * @experimental WebWorker support is currently experimental.
 */
export const /** @type {?} */ WORKER_UI_STARTABLE_MESSAGING_SERVICE = new OpaqueToken('WorkerRenderStartableMsgService');
